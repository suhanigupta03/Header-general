...
const Header = () => {
  ...
  return ( 
    <nav className='bg-gradient-to-r from-red-500 to-red-500 flex '>
    ...
    >
      ...
      />
        ...
        <ul className={`md:flex ${dropdownOpen ? 'block' : 'hidden'}`}>
          ...
          <li> 
          <div className="dropdown">
             <button className='block py-2 px-4 md:px-2 text-black hover:bg-white-500'>Student</button>
             <div class="dropdown-content">
                <a href="/Courses">Courses & Fees</a>
                <a href="/Department">Admission inquiry</a>
                <a href="/FacilitiesOffered">Student List</a>
                <a href="/FacilitiesOffered">E-Brochure</a>
                <a href="/FacilitiesOffered">Result</a>
            </div>
          </div>
          </li> 
          <li>
          <div class="dropdown">
             <button className='block py-2 px-4 md:px-2 text-black hover:bg-white-500'>NCSIM Mandates</button>
              <div class="dropdown-content">
                <a href="/hostel">Principal and Medical superintendent</a>
                <a href="/lab">Intake capacity</a>
                {/* <a href="#">Hospital</a> */}
                <a href="/lab">Staff List</a>
                <a href="/gym">Student details</a> 
                <a href="/Classroom">Research Publications</a>
                <a href="/Classroom">Conferences and Aacademic activities</a>
                <a href="/Classroom">Attendance Report</a>
                <a href="/Classroom">Affiliations</a>
                <a href="/Classroom">Clinical Material in Hospital</a>
                <a href="/Classroom">Hospital Month wise OP/IP Statistics</a>
             </div>
          </div>
           ...
           <li>
          <div class="dropdown">
             <button className='block py-2 px-4 md:px-2 text-black hover:bg-white-500'>Facilities</button>
              <div class="dropdown-content">
          ...
          <li>
          <div class="dropdown">
             <button className='block py-2 px-4 md:px-2 text-black hover:bg-white-500'>Media</button>
              {/* <div class="dropdown-content">
          ...
          <li>
            <a href="/gallery" className='block py-2 px-4 md:px-2 text-black hover:bg-white-500'>Hospital Clinical Data</a>
          </li>
          <li>
